...
//    }
    ...
    void updateBook() {
        ...
        assertNotNull(generalResponseDTO);
        assertEquals(TestUtil.getUpdateBook().getAuthor(),( (Book)generalResponseDTO.getData()).getAuthor());
    ...
    void disableUser() {
      ...
      //  when(userRepository.findByUserName(any(String.class))).thenReturn(Optional.empty());
        ...
        assertNotNull(generalResponseDTO);
        assertEquals(true, generalResponseDTO.isSuccess());
    ...
    void deleteBook() {
        ...
        assertNotNull(generalResponseDTO);
        assertEquals(true, ((BookUserDTO) generalResponseDTO.getData()).getDeleted() );
    }
